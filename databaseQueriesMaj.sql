...
INSERT INTO Category (id, name, description,image_url,is_active) VALUES (1,'Parfum', 'La description pour la catégorie parfum!', 'CAT_1.png', true);
INSERT INTO Category (id, name, description,image_url,is_active) VALUES (2,'Accessoires', 'La description pour la catégorie accessoires!', 'CAT_2.png', true);
INSERT INTO Category (id, name, description,image_url,is_active) VALUES (3,'Maquillage', 'La description pour la catégorie maquillage!', 'CAT_3.png', true);
INSERT INTO Category (id, name, description,image_url,is_active) VALUES (4,'Chaussures', 'La description pour la catégorie chaussures!', 'CAT_3.png', true);
INSERT INTO Category (name, description,image_url,is_active) VALUES ('Cat', 'cat!', 'CAT_3.png', true);
-- adding three users 
...
INSERT INTO Cart (id, user_id, grand_total, cart_lines) VALUES (1, 3, 18, 1);

INSERT INTO CartLine (cart_id, total, product_id, product_count, buying_price, is_available) 
VALUES (1, 18, 1, 1, 18, true);